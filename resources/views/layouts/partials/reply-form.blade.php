{{-- This is the form for posting a reply on a comment. It is hidden my default, and is toggled by clicking a link --}}

<div class="reply-form-{{$comment->id}} hidden mt-6">
