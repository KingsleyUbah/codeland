...
<body class="bg-gray-200">    
    ...
    <div class="max-w-7xl mx-auto h-20 flex justify-between divide-x divide-gray-300 items-center">
            ...
            <div class="w-9/12 flex items-center justify-between p-5">
                ...
                @auth
                <a class="shadow-lg font-semibold bg-blue-500 hover:bg-red-900 p-2 text-gray-200 rounded-lg font-body" href="{{route('thread.create')}}" id="thread-btn">Create Thread</a>
                @endauth
            </div>
    </div>
