...
@section('content')
    ...
    <div class="flex items-start" >
        ...
        <div class="w-full">
            ...
            <div class="">{!! \Michelf\Markdown::defaultTransform($thread->body) !!}</div>
            ...
            @endauth
                <div class="flex items-center">
                    <span class="mr-3 italic text-gray-500">{{ $thread->likes->count() }} {{ Str::plural('person', $thread->likes->count()) }} liked this</span>
                    @auth
